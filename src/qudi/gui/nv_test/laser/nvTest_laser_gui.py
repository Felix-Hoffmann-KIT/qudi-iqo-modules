...
from qudi.gui.nv_test.laser.nvTest_laser_window import NvTestLaserMainWindow


# qudi GUI measurement modules must inherit qudi.core.module.GuiBase or other GUI modules.
class NvTestLaserGui(GuiBase):
    ...
    _nvTest_logic = Connector(name='nvTest_laser_logic', interface='NvTestLaserLogic')
    ...
    def on_activate(self) -> None:
        ...
        self._mw = NvTestLaserMainWindow()
        self._mw.count_spinbox.setValue(self._nvTest_logic().counter_value)
        ...
        self.sigAddToCounter.connect(
            self._nvTest_logic().add_to_counter, QtCore.Qt.QueuedConnection
        )

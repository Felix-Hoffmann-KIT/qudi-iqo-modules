...
from qudi.gui.nv_test.microwave.nvTest_microwave_window import NvTestMicrowaveMainWindow


# qudi GUI measurement modules must inherit qudi.core.module.GuiBase or other GUI modules.
class NvTestMicrowaveGui(GuiBase):
    ...
    def on_activate(self) -> None:
        ...
        self._mw = NvTestMicrowaveMainWindow()
